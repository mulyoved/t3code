...
import type {
  ExtensionComposerIcon,
  ExtensionComposerSelectResult,
} from "../../extensions/composer";
...
export type ComposerCommandItem =
  ...
  | {
      ...
      icon?: ExtensionComposerIcon | undefined;
      badge?: string | undefined;
      onSelect?: () =>
        | ExtensionComposerSelectResult
        | Promise<ExtensionComposerSelectResult>
        | undefined;
    }
  | {
      id: string;
...
function SlashCommandIcon(props: { command: string; icon?: ExtensionComposerIcon }) {
